...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"ra.exam.controller", "ra.exam.service.imp", "ra.exam.repository.imp", "ra.exam.config"})
...
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/examMd3");
...
//        properties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQL8InnoDBDialect");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.exam.model");
